...
const baseCompany = {
  ...
  status: "activ",
  location: ["București"],
  website: ["https://www.mejix.com"],
  career: ["https://www.mejix.com"],
  lastScraped: "2026-06-17"
};

const baseJob = {
  url: "https://www.mejix.com/en/vacancy/123_en",
...
describe("generateJobsMarkdown", () => {
  describe("company section", () => {
    it("includes company name as h1", () => {
      ...
      expect(md).toContain("# MEJIX SRL");
    });

    it("includes CIF", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("17372688");
    });

    it("includes brand", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("MEJIX");
    });
    ...
    it("includes website as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("[https://www.mejix.com](https://www.mejix.com)");
    });
    ...
    it("omits optional fields when not present", () => {
      const minimal = { id: "17372688", company: "MEJIX SRL" };
  ...
  describe("jobs section", () => {
    ...
    it("includes job URL as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, [baseJob]);
      expect(md).toContain("[https://www.mejix.com/en/vacancy/123_en]");
    });
    ...
    it("renders multiple jobs", () => {
      const job2 = { ...baseJob, title: "DevOps Engineer", url: "https://www.mejix.com/en/vacancy/456_en" };
    ...
    it("handles job with no optional fields", () => {
      const minimal = { url: "https://www.mejix.com/en/vacancy/999_en", title: "QA Engineer" };
