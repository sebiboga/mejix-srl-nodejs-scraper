...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "MEJIX") |
| group        | string   | Parent company group (e.g. "MEJIX") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/mejix-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)